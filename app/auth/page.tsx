...
const Auth = () => {
  ...
  const onSubmit = async (data: LoginSchema) => {
    ...
    return res.error ? setOpen(true) : router.push("/");
  };
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          <form onSubmit={handleSubmit((data) => onSubmit(data))}>
            ...
            <div>
              ...
              <button
                className=" mt-10 inline-flex h-10 w-full items-center justify-center gap-2 
                        rounded border border-slate-300 bg-white p-2 text-sm font-medium
                         text-black outline-none focus:ring-2 focus:ring-[#333] focus:ring-offset-1 
